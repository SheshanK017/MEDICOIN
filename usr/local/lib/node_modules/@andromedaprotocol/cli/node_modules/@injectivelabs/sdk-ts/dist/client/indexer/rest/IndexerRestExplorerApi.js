...
class IndexerRestExplorerApi extends BaseRestConsumer_1.default {
    ...
    fetchBlock(blockHashHeight) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = (yield this.get(`blocks/${blockHashHeight}`));
    ...
    fetchBlocks(params) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = (yield this.get('blocks', {
                    before,
                    limit,
                }));
    ...
    fetchTransactions(params) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = (yield this.get('txs', {
                    limit,
                    after,
                    before,
    ...
    fetchAccountTransactions({ account, params, }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = (yield this.get(`accountTxs/${account}`, {
                    skip,
                    limit,
                    after,
                    before,
    ...
    fetchTransaction(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = (yield this.get(`txs/${hash}`));
    ...
    fetchValidators() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = (yield this.get(`validators`));
    ...
    fetchValidatorUptime(validatorConsensusAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = (yield this.get(`validator_uptime/${validatorConsensusAddress}`));
                if (!response.data || !response.data.data) {
                    return [];
                }
    ...
    fetchContract(contractAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = (yield this.get(`/wasm/contracts/${contractAddress}`));
    ...
    fetchContracts(params) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = (yield this.get('/wasm/contracts', {
                    skip,
                    limit,
    ...
    fetchContractTransactions({ contractAddress, params, }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = (yield this.get(`/contractTxs/${contractAddress}`, {
                    skip,
                    limit,
                    to_number: toNumber,
                    from_number: fromNumber,
    ...
    fetchWasmCode(codeId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = (yield this.get(`/wasm/codes/${codeId}`));
    ...
    fetchWasmCodes(params) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = (yield this.get('/wasm/codes', {
                    limit,
                    from_number: fromNumber,
                    to_number: toNumber,
                }));
    ...
    fetchCW20Balances(address) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = (yield this.get(`/wasm/${address}/cw20-balance`));
