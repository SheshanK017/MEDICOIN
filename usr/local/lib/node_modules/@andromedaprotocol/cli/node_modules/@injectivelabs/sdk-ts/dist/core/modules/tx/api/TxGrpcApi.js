...
class TxGrpcApi {
    ...
    broadcast(txRaw, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield new Promise((resolve, reject) => txService.broadcastTx(broadcastTxRequest, (error, response) => __awaiter(this, void 0, void 0, function* () {
                    if (error || !response) {
                        return reject(error);
                    }
                    const txResponse = response.getTxResponse();
                    if (txResponse.getCode() === 0) {
                        return resolve(Object.assign(Object.assign({}, txResponse.toObject()), { txHash: txResponse.getTxhash() }));
                    }
                    const result = yield this.fetchTxPoll(txResponse.getTxhash(), timeout);
