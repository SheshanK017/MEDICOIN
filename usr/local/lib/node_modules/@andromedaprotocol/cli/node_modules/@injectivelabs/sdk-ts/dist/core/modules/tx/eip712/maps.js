...
exports.protoTypeToAminoType = exports.getObjectEip712PropertyType = exports.mapValuesToProperValueType = exports.numberTypeToReflectionNumberType = exports.objectKeysToEip712Types = void 0;
    ...
    return Object.keys(object).reduce((result, key) => {
        ...
        if (typeof value === 'object') {
            if (Array.isArray(value)) {
                return Object.assign(Object.assign({}, result), { [key]: value.map((item) => (0, exports.mapValuesToProperValueType)(item)) });
            }
        ...
        if (typeof value === 'string') {
            if (sdkDecKeys.includes(key)) {
                return Object.assign(Object.assign({}, result), { [key]: (0, utils_1.numberToCosmosSdkDecString)(value) });
            }
            // Message Type Specific checks
            if (messageTypeUrl) {
