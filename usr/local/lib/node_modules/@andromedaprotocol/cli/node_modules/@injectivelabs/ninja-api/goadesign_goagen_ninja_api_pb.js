...
proto.ninja_api.Vault.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    redemptionUnlockTimeExpiration: jspb.Message.getFieldWithDefault(msg, 15, 0)
  };
...
proto.ninja_api.Vault.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 15:
      var value = /** @type {number} */ (reader.readSint64());
      msg.setRedemptionUnlockTimeExpiration(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.ninja_api.Vault.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getRedemptionUnlockTimeExpiration();
  if (f !== 0) {
    writer.writeSint64(
      15,
      f
...
/**
 * optional sint64 redemption_unlock_time_expiration = 15;
 * @return {number}
 */
proto.ninja_api.Vault.prototype.getRedemptionUnlockTimeExpiration = function() {
 ...
 * @return {!proto.ninja_api.Vault} returns this
 */
proto.ninja_api.Vault.prototype.setRedemptionUnlockTimeExpiration = function(value) {
