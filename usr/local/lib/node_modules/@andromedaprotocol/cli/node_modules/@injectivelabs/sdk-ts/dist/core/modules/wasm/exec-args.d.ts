...
export type ExecArgs = ExecArgCW20AdapterRedeemAndTransfer | ExecArgCW20Send | ExecArgCW20Transfer | ExecArgDepositTokens | ExecArgIncreaseAllowance | ExecArgInitiateTransfer | ExecArgRegisterVault | ExecArgSubmitVaa | ExecArgUpdateDerivativeVaultConfig | ExecArgUpdateSpotVaultConfig;
export type ExecPrivilegedArgs = ExecPrivilegedArgRegisterVault | ExecPrivilegedArgVaultRedeem | ExecPrivilegedArgVaultSubscribe;
