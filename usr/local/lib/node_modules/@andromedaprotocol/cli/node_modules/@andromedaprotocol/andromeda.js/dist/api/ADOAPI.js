...
class ADOAPI {
     ...
     * @returns
     */
    async updateOwner(newOwner, addr = this.address, fee, memo) {
     ...
     * @returns
     */
    async updateOperators(operators, addr = this.address, fee, memo) {
     ...
     * @returns
     */
    updateAppContractMsg(appContract) {
     ...
     * @returns
     */
    async updateAppContract(appContract, addr = this.address, fee, memo) {
     ...
     * @returns
     */
    async registerModule(module, addr = this.address, fee, memo) {
     ...
     * @returns
     */
    async deregisterModule(id, addr = this.address, fee, memo) {
     ...
     * @returns
     */
    async alterModule(id, module, addr = this.address, fee, memo) {
     ...
     * @returns
     */
    async refreshAddress(key, addr = this.address, fee, memo) {
     ...
     * @returns
     */
    refreshAddressesMsg(startAfter, limit) {
        return this.andromedaReceive({
     ...
     * @returns
     */
    async refreshAddresses(startAfter, limit, addr = this.address, fee, memo) {
     ...
     * @returns
     */
    async getOperators(addr = this.address) {
        const query = this.operatorsQuery();
        const resp = await this.client.queryContract(addr, query);
     ...
     * @returns
     */
    async getOwner(addr = this.address) {
     ...
     * @returns
     */
    async isOperatorOrOwner(addr, contractAddr = this.address) {
     ...
     * @returns
     */
    async getType(addr = this.address) {
     ...
     * @returns
     */
    async getPublisher(addr = this.address) {
     ...
     * @returns
     */
    async getCreatedHeight(addr = this.address) {
     ...
     * @returns
     */
    async getVersion(addr = this.address) {
     ...
     * @returns
     */
    async getModule(id, addr = this.address) {
     ...
     * @returns
     */
    async getModuleIds(addr = this.address) {
     ...
     * @returns
     */
    async getModules(addr = this.address) {
