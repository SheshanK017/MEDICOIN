...
export default class ADOAPI {
     ...
     * @returns
     */
    updateOwner(newOwner: string, addr?: string, fee?: Fee, memo?: string): Promise<import("@cosmjs/cosmwasm-stargate").ExecuteResult>;
    /**
     ...
     * @returns
     */
    updateOperators(operators: string[], addr?: string, fee?: Fee, memo?: string): Promise<import("@cosmjs/cosmwasm-stargate").ExecuteResult>;
    /**
     ...
     * @returns
     */
    refreshAddress(key: string, addr?: string, fee?: Fee, memo?: string): Promise<import("@cosmjs/cosmwasm-stargate").ExecuteResult>;
    /**
     ...
     * @returns
     */
    refreshAddresses(startAfter?: string, limit?: number, addr?: string, fee?: Fee, memo?: string): Promise<import("@cosmjs/cosmwasm-stargate").ExecuteResult>;
    /**
     * Query Messages
     */
    /**
     ...
     * @returns
     */
    getOperators(addr?: string): Promise<string[]>;
    /**
     ...
     * @returns
     */
    isOperatorOrOwner(addr: string, contractAddr?: string): Promise<boolean>;
    /**
    ...
    getModule(id: string | number, addr?: string): Promise<{
        idx: number;
        module_type: string;
        address: import("../types").AndrAddress;
        is_mutable: boolean;
    }>;
    /**
