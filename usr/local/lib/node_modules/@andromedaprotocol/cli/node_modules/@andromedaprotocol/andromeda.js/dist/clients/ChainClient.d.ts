...
import type { CosmWasmClient, DeliverTxResponse, ExecuteResult, InstantiateOptions, InstantiateResult, MigrateResult, MsgExecuteContractEncodeObject, MsgInstantiateContractEncodeObject, MsgMigrateContractEncodeObject, MsgStoreCodeEncodeObject, SigningCosmWasmClient, SigningCosmWasmClientOptions, UploadResult } from "@cosmjs/cosmwasm-stargate";
...
export default interface ChainClient {
    signingClient?: SigningCosmWasmClient | TxGrpcClient | LCDClient | SigningArchwayClient;
     ...
     * @param options
     */
    connect(endpoint: string, signer?: OfflineSigner | OfflineDirectSigner, options?: SigningCosmWasmClientOptions): Promise<void>;
    /**
     ...
     * @param memo
     */
    sign(messages: EncodeObject[], fee?: Fee, memo?: string): ReturnType<SigningCosmWasmClient["sign"]> | TerraTx;
    /**
     * Broadcasts a given transaction to the connected chain
     * @param tx
     */
    broadcast(tx: TxRaw | InjTxRaw | TerraTx): ReturnType<SigningCosmWasmClient["broadcastTx"]>;
    /**
     ...
     * @param memo
     */
    simulateMulti(messages: readonly EncodeObject[], fee?: Fee, memo?: string): ReturnType<SigningCosmWasmClient["simulate"]>;
    /**
     ...
     * @param memo
     */
    simulate(message: EncodeObject, fee?: Fee, memo?: string): ReturnType<SigningCosmWasmClient["simulate"]>;
     ...
     * @param memo
     */
    simulateExecute(address: string, msg: Msg, funds: Coin[], fee?: Fee, memo?: string): Promise<number | undefined>;
    /**
     ...
     * @param memo
     */
    simulateUpload(code: Uint8Array, fee?: Fee, memo?: string): Promise<number | undefined>;
    /**
     ...
     * @param memo
     */
    simulateMigrate(contractAddress: string, codeId: number, msg: Msg, fee?: Fee, memo?: string): Promise<number | undefined>;
    /**
     ...
     * @returns
     */
    encodeInstantiateMsg(codeId: number, msg: Msg, label: string): MsgInstantiateContractEncodeObject;
    /**
